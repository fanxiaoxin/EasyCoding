...
open class ECOptionsTextConstraint<OptionsKeyboardType: ECOptionsKeyboardType>: ECTextConstraint {
...
extension ECTextConstraint {
    public static func options<KeyboardType: ECOptionsKeyboardType>(_ keyboard: KeyboardType) -> ECTextConstraint {
        let c = ECOptionsTextConstraint<KeyboardType>(keyboard)
        return c
    }
}
