...
extension ECApiManagerType {
    ...
    ///成功时调用
    public static func onCompletionSuccess<ApiType: ECResponseApiType>(plugins: [PluginType],api: ApiType ,response: ApiType.ResponseType, completion:(Swift.Result<ApiType.ResponseType, Error>) -> Void) {
...
extension MoyaError: ECTextualizable {
    ///比较友好的给用户看的信息
