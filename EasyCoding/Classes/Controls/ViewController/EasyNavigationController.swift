...
open class EasyNavigationController: UINavigationController,UIGestureRecognizerDelegate, EasyViewControllerType {
    ///可由外部设置
    open var segue: EasyPresentSegue = EasyPresentSegue.push
    
    ///可由外部设置
    open var preconditions: [EasyViewControllerCondition]? = nil
    ///只有根控制器显示Tabbar
