...
open class ECPickerView : UIView{
    ///可配置样式
    open class Style {
        ///标题颜色
    ...
    fileprivate func loadLayoutAndStyle(){
        ...
        titleLabel.textColor = ECPickerView.Style.titleColor
        titleLabel.font = ECPickerView.Style.titleFont
        titleLabel.textAlignment = .center
        titleLabel.layer.borderWidth = 1
        titleLabel.layer.borderColor = ECPickerView.Style.borderColor?.cgColor
        ...
        confirmButton.setTitleColor(ECPickerView.Style.buttonColor, for: .normal)
        confirmButton.setTitleColor(ECPickerView.Style.buttonHoverColor, for: .highlighted)
        confirmButton.titleLabel?.font = ECPickerView.Style.buttonFont
        ...
        cancelButton.setTitleColor(ECPickerView.Style.buttonColor, for: .normal)
        cancelButton.setTitleColor(ECPickerView.Style.buttonHoverColor, for: .highlighted)
        cancelButton.titleLabel?.font = ECPickerView.Style.buttonFont
