...
extension ECStyleSetting where TargetType: ECTextView {
    ///占位文本
    public static func placeholder(_ text:String?, color: UIColor? = nil, font: UIFont? = nil) -> ECStyleSetting<TargetType> {
