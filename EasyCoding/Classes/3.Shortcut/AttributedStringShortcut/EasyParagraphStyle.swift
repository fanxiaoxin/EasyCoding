...
public enum EasyParagraphStyleSetter {
...
extension EasyCoding where Base: NSMutableParagraphStyle {
    public func apply(setter: EasyParagraphStyleSetter) {
        switch setter {
...
extension EasyStringAttribute {
    ///段落样式
    public static func paragraph(_ setters: EasyParagraphStyleSetter...) -> EasyStringAttribute {
