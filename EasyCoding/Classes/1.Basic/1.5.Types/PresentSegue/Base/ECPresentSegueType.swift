...
extension EC.NamespaceImplement where Base: UIViewController {
    ...
    internal func currentSegue(_ segue: ECPresentSegueType?) {
        self.setAssociated(object: segue, key: EC.key("PresentSegueType"))
    }
    public func show(_ viewController: UIViewController ,segue: ECPresentSegueType){
