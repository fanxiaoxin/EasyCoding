//
//  ECPresentAnimation_Group.swift
//  EasyCoding
//
...
extension ECPresentAnimation {
    ///多个动画同时做
    public struct Group: ECPresentAnimationType {
        ///最长的动画时长
        ...
        ///delay: 每个动画的延时显示
        ///aniamtion: 具体动画
        public var animations: [(tag: Int?, delay: TimeInterval, aniamtion: ECPresentAnimationType)] = []
